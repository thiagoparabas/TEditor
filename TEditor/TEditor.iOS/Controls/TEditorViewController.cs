...
namespace TEditor
{
    ...
    [Register("TEditorViewController")]
    public sealed class TEditorViewController : UIViewController
    {
        ...
        void LayoutToolBarHolder()
        {
            ...
            if (!IsIpad())
            {
                ...
                UIView toolbarCropper = new UIView(new CGRect(View.Frame.Width - 44, 0, 44, 44));
        ...
        public void LoadResource()
        {
            ...
            _webView.LoadHtmlString(htmlResource, new NSUrl("www.xam-consulting.com"));
        }
